...
class stationbbc(station):
	def __init__(self,name,code,nomcode="",streamurl="",titlearg="",urlarg=""):
		podurlcomp= "https://www.bbc.co.uk/podcasts/"+nomcode+"/a-z"
...
class emissionbbc(emission):
	def __init__(self,name,idpod,nomcode):
		podcasturl="https://downloads.bbc.co.uk/podcasts/"+nomcode+"/"+str(idpod)+"/rss.xml"
...
bbc1 = stationbbc('bbc 1','bbc1',"radio1","https://www.bbc.co.uk/radio/listen/live/r1_aaclca.pls",".pc-result-heading a",".pc-result-heading a")
bbc2 = stationbbc('bbc 2','bbc2',"radio2","https://www.bbc.co.uk/radio/listen/live/r2_aaclca.pls",".pc-result-heading a",".pc-result-heading a")
bbc3 = stationbbc('bbc 3','bbc3',"radio3","https://www.bbc.co.uk/radio/listen/live/r3_aaclca.pls",".pc-result-heading a",".pc-result-heading a")
bbc4 = stationbbc('bbc 4','bbc4',"radio4","https://www.bbc.co.uk/radio/listen/live/r4_aaclca.pls",".pc-result-heading a",".pc-result-heading a")
bbc5 = stationbbc('bbc 5','bbc5',"5live" ,"https://www.bbc.co.uk/radio/listen/live/r5_aaclca.pls",".pc-result-heading a",".pc-result-heading a")
bbc6 = stationbbc('bbc 6','bbc6',"6music","https://www.bbc.co.uk/radio/listen/live/r6_aaclca.pls",".pc-result-heading a",".pc-result-heading a")
